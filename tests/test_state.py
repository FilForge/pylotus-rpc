...
def test_wait_msg_limited(setup_connector):
    result = _wait_msg_limited(setup_connector, "bafy2bzacecxnn5axzy3vvzwounoygubhbydfvfh5bopdhwoc5lfi6itwgj5tw", 0, 1000000)
...
def test_verified_registry_root_key(setup_connector):
    result = _verified_registry_root_key(setup_connector)
    assert result is not None
    assert result == 'f080'
